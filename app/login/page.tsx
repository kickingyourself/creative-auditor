...
export default function LoginPage() {
  ...
  return (
    <>
      {/* Full-screen backdrop — covers sidebar and header */}
      <div
        style={{
          position: "fixed",
          inset: 0,
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Lock size={15} color={state.status === "error" ? "#c85a4a" : "#58584f"} style={{ flexShrink: 0 }} />
                  <input
                    id="password-input"
                    ref={inputRef}
                    name="password"
              ...
              <button
                ...
                onMouseLeave={(e) => {
                  ...
                  (e.currentTarget as HTMLButtonElement).style.boxShadow = pending ? "none" : "0 4px 18px rgba(79,179,186,0.35)";
                }}
              >
                {pending ? (
